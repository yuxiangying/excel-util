...
public class RateBootstrap {
    ...
    public static void main(String[] args) throws IntrospectionException, InvocationTargetException, IllegalAccessException {
        ...
        for (int rateCode : rateCodes) {
            ...
            String fileTemplatePath = "C:/ideaProject/guohua/excel-util/excel/rate/template/" + fileName + "模板.xlsx";
            String outFilePath = "C:/ideaProject/guohua/excel-util/excel/rate/" + fileName + ".xlsx";
            //主险
